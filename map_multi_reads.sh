...
mkdir Multi_Mapped_Reads

#Define sub-dir structure
trimdir=Trimmed_Reads
mapdir=Multi_Mapped_Reads
...
bowtie2 -a -p 4 -x $index -U $trimdir/$filename 2> $mapdir/$shortname.bowtie.mapping.log.txt -S $mapdir/$shortname.bowtie.multimapping.sam
